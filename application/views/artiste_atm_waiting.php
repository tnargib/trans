<main>
    ...
    <ul class="nav nav-tabs nav-justified">
      ...
      <li role="presentation" class="active"><a href="<?php echo site_url('atm_artiste_control/waiting') ?>">Inscription en attente</a></li>
      <li role="presentation"><a href="<?php echo site_url('atm_artiste_control/refused') ?>">Inscription refusés</a></li>
    </ul>
